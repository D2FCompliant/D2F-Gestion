...
type SupportCopy = {
  ...
  ticketScope: string; requestType: string; reanalyze: string; qualifyCountryPack: string;
...
export const supportCopies: Record<SupportLanguage, SupportCopy> = {
  fr: {
    ...
    ticketScope: "Visibilité", requestType: "Nature de la demande", reanalyze: "Relancer l’analyse déterministe", qualifyCountryPack: "Qualifier le Country Pack",
    ...
    authors: { requester: "Demandeur", support: "Support D2F", assistant: "Analyse guidée D2F", system: "Suivi du ticket" },
  ...
  en: {
    ...
    ticketScope: "Visibility", requestType: "Request type", reanalyze: "Run deterministic analysis", qualifyCountryPack: "Qualify Country Pack",
    ...
    authors: { requester: "Requester", support: "D2F Support", assistant: "D2F guided analysis", system: "Ticket tracking" },
  ...
  sr: {
    ...
    ticketScope: "Vidljivost", requestType: "Vrsta zahteva", reanalyze: "Ponovi determinističku analizu", qualifyCountryPack: "Kvalifikuj Country Pack",
    ...
    authors: { requester: "Podnosilac", support: "D2F podrška", assistant: "D2F vođena analiza", system: "Praćenje tiketa" },
  ...
  it: {
    ...
    ticketScope: "Visibilità", requestType: "Tipo di richiesta", reanalyze: "Ripeti l’analisi deterministica", qualifyCountryPack: "Qualifica il Country Pack",
    ...
    authors: { requester: "Richiedente", support: "Supporto D2F", assistant: "Analisi guidata D2F", system: "Monitoraggio ticket" },
  ...
  es: {
    ...
    ticketScope: "Visibilidad", requestType: "Tipo de solicitud", reanalyze: "Repetir análisis determinista", qualifyCountryPack: "Cualificar el Country Pack",
    ...
    authors: { requester: "Solicitante", support: "Soporte D2F", assistant: "Análisis guiado D2F", system: "Seguimiento del ticket" },
