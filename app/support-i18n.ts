...
export const supportCopies: Record<SupportLanguage, SupportCopy> = {
  fr: {
    ...
    ticketScope: "Visibilité", requestType: "Nature de la demande", reanalyze: "Relancer l’analyse déterministe",
  ...
  en: {
    ...
    ticketScope: "Visibility", requestType: "Request type", reanalyze: "Run deterministic analysis",
  ...
  sr: {
    ...
    ticketScope: "Vidljivost", requestType: "Vrsta zahteva", reanalyze: "Ponovi determinističku analizu",
  ...
  it: {
    ...
    ticketScope: "Visibilità", requestType: "Tipo di richiesta", reanalyze: "Ripeti l’analisi deterministica",
  ...
  es: {
    ...
    ticketScope: "Visibilidad", requestType: "Tipo de solicitud", reanalyze: "Repetir análisis determinista",
