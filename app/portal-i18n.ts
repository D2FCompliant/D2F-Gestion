...
export const portalCopies: Record<PortalLocale, PortalCopy> = {
  fr: {
    brandTitle: "D2F Platform, votre gestion conforme et modulaire.",
    brandLead: "D2F Gestion, Financial et Expenses réunis dans un espace sécurisé, activés selon les options de votre établissement.",
    ...
    pricingPlan: "Offre D2F Platform", pricingPeriod: "/ mois et par établissement", pricingTax: "Prix hors taxes — TVA selon le pays et le statut fiscal.",
    pricingScope: "1 établissement facturant (un SIRET en France)", pricingSeats: "2 utilisateurs inclus", pricingIncluded: "Hébergement sécurisé, mises à jour et fonctions D2F Platform inclus",
    ...
    creating: "Création…", createCompany: "Créer l’établissement", passwordSecurity: "Votre mot de passe est géré par Supabase Auth et n’est jamais enregistré par D2F Platform.",
  ...
  en: {
    brandTitle: "D2F Platform, compliant and modular business management.",
    brandLead: "D2F Gestion, Financial and Expenses in one secure workspace, enabled according to your establishment options.",
    ...
    pricingPlan: "D2F Platform plan", pricingPeriod: "/ month per establishment", pricingTax: "Price excludes tax — VAT depends on country and tax status.",
    pricingScope: "1 invoicing establishment (one SIRET in France)", pricingSeats: "2 users included", pricingIncluded: "Secure hosting, updates and D2F Platform features included",
    ...
    creating: "Creating…", createCompany: "Create establishment", passwordSecurity: "Your password is managed by Supabase Auth and is never stored by D2F Platform.",
  ...
  sr: {
    brandTitle: "D2F Platform, usklađeno i modularno upravljanje.",
    brandLead: "D2F Gestion, Financial i Expenses u jednom bezbednom prostoru, prema opcijama vašeg sedišta.",
    ...
    pricingPlan: "D2F Platform paket", pricingPeriod: "/ mesečno po poslovnom sedištu", pricingTax: "Cena ne uključuje porez — PDV zavisi od zemlje i poreskog statusa.",
    pricingScope: "1 izdavalac faktura (jedan SIRET u Francuskoj)", pricingSeats: "2 korisnika uključena", pricingIncluded: "Bezbedan hosting, ažuriranja i D2F Platform funkcije su uključeni",
    ...
    creating: "Kreiranje…", createCompany: "Kreiraj preduzeće", passwordSecurity: "Lozinkom upravlja Supabase Auth i D2F Platform je nikada ne čuva.",
  ...
  it: {
    brandTitle: "D2F Platform, gestione conforme e modulare.", brandLead: "D2F Gestion, Financial ed Expenses in un unico spazio sicuro, attivati secondo le opzioni della sede.",
    ...
    pricingPlan: "Piano D2F Platform", pricingPeriod: "/ mese per sede", pricingTax: "Prezzo al netto delle imposte — IVA secondo il Paese e lo status fiscale.",
    pricingScope: "1 sede di fatturazione (un SIRET in Francia)", pricingSeats: "2 utenti inclusi", pricingIncluded: "Hosting sicuro, aggiornamenti e funzioni D2F Platform inclusi",
    ...
    creating: "Creazione…", createCompany: "Crea la sede", passwordSecurity: "La password è gestita da Supabase Auth e non viene mai memorizzata da D2F Platform.",
  ...
  es: {
    brandTitle: "D2F Platform, gestión conforme y modular.", brandLead: "D2F Gestion, Financial y Expenses en un espacio seguro, activados según las opciones del establecimiento.",
    ...
    pricingPlan: "Plan D2F Platform", pricingPeriod: "/ mes por establecimiento", pricingTax: "Precio sin impuestos — IVA según el país y la situación fiscal.",
    pricingScope: "1 establecimiento emisor (un SIRET en Francia)", pricingSeats: "2 usuarios incluidos", pricingIncluded: "Alojamiento seguro, actualizaciones y funciones de D2F Platform incluidos",
    ...
    creating: "Creando…", createCompany: "Crear establecimiento", passwordSecurity: "La contraseña la gestiona Supabase Auth y D2F Platform nunca la almacena.",
