...
export default function SessionShell() {
  ...
  return <main className="app-session-shell">
    ...
    {session.account.canUseApplication ? <iframe className="web-app-frame" src="/erp/index.html?v=20260716-quote-lifecycle-v5" title="D2F Gestion" allow="clipboard-read; clipboard-write" /> : <LockedSubscription session={session} onOpen={() => setDrawer(true)} />}
