...
export default function SessionShell({ monthlyPriceEur, annualPriceEur }: { monthlyPriceEur: number; annualPriceEur: number }) {
  ...
  return <main className="app-session-shell">
    ...
    {session.account.canUseApplication ? <iframe className="web-app-frame" src="/erp/index.html?v=20260717-csv-history-v215" title="D2F Gestion" allow="clipboard-read; clipboard-write" /> : <LockedSubscription session={session} onOpen={() => setDrawer(true)} onSession={setSession} />}
