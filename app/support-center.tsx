          ...
          {creating ? <form className="support-new-form" onSubmit={createTicket}>
            ...
            <div className="support-form-grid">
              {payload?.isAdmin
                ...
                : <label>{copy.ticketScope}<select defaultValue="customer" disabled aria-disabled="true"><option value="customer">{copy.scopes.customer}</option></select><input type="hidden" name="ticketScope" value="customer" /></label>}
