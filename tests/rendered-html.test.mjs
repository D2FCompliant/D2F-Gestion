...
test("server-renders the D2F Platform cockpit", async () => {
  ...
  assert.match(shell, /src="\/erp\/index\.html\?v=20260722-supabase-key-compat-v3317"/);
...
test("ships a touch-first smartphone layout", async () => {
  ...
  assert.match(html, /styles\.css\?v=20260722-supabase-key-compat-v3317/);
  assert.match(html, /app\.js\?v=20260722-supabase-key-compat-v3317/);
...
test("keeps every workspace scrollable and text contained on 13-inch screens", async () => {
  ...
  assert.match(html, /styles\.css\?v=20260722-supabase-key-compat-v3317/);
  assert.match(shell, /erp\/index\.html\?v=20260722-supabase-key-compat-v3317/);
});
